...
This shows  our Implentation can be used to Identify a Specific Crop and assess productivity of crops to identify site-specific issues that can be addressed by corrective management decisions.
